#!/usr/bin/env python
"""inttowig.py <intensity_file>

Output intensities to intensity_file.wig for use in UCSC browser
"""
...
header = 'track type=wiggle_0 name="SMC data" description="MISMC data from tiling arrays" visibility=full autoScale=off viewLimits=-50:100 color=0,200,100 maxHeightPixels=100:50:20 graphType=points priority=30\nvariableStep chrom=chr2L span=5\n'
